...
namespace PSharp.Scripting
{
    ...
    public struct AMXArgumentList
    {
        ...
        public AMXArgumentList(IntPtr pointer)
        {
            m_pointer = pointer;
        }
        ...
        public Int32 Length
        {
            get { return Marshal.ReadInt32(m_pointer) / Marshal.SizeOf(typeof(Cell)); }
        }

        public Cell this[Int32 index]
        {
            get { return Cell.FromIntPtr(IntPtr.Add(m_pointer, (index + 1) * Marshal.SizeOf(typeof(Cell)))); }
        }
    }
}
